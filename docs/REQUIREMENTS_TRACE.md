...
| Public brand is professional and simple | Public marketplace uses `TrataPro`, slogan `Trabalho certo. Prova feita.`, visible `logo.svg` wordmark, `TP` SVG icon, updated PWA icon and server-generated SEO site names |
