...
| Public homepage feels like a job network | `/` renders a modern LinkedIn-like landing with compact top search, candidate/company entry cards, market metrics, vacancy feed, quick filters, polished job cards and account actions before any private project entry |
